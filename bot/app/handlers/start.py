...
async def cmd_start(message: Message, session: AsyncSession):
    ...
    welcome_text = (
        ...
        f"Используй команду /help для просмотра всех доступных команд."
    )
...
async def cmd_help(message: Message):
    ...
    help_text = (
        ...
        "/addfavorite <город> - добавить город в избранное\n"
        "/removefavorite <город> - удалить город из избранного\n\n"
        "📰 Новости:\n"
        ...
        "/daily <HH:MM> - настроить ежедневную рассылку погоды\n"
        "/daily_off - отключить ежедневную рассылку\n\n"
        "ℹ️ Другое:\n"
        "/menu - главное меню\n"
